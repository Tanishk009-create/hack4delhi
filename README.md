...
4. Academic sensor+ML works: Machine learning applied for obstacle & crack detection on tracks using camera and IoT sensor data.
5. IoT-Enabled Railway Track Crack Detection System: Presented at the International Conference on Innovative Computing & Communication, this research integrates IoT sensors along the track to detect cracks and anomalies in real time.
